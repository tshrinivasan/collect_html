...
# Version : 1.0
# Description : A program to combine contents of all the html files from all the subdirectories of a given directory
...
This program combines contents of all the html files
from all the subdirectories of given directory.

"""

parser = optparse.OptionParser(description=desc, version='%prog version 1.0')
parser.add_option('-t', '--target', help='target folder to collect html files', dest='target')
...
target_file = "./" + opts.target.split('/')[0] + "_collected_" + timestamp + ".html"
